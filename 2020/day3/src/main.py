...
def trees_hit_multiple_inputs(mountain, inputs):
    total_trees = 1
    for element in inputs:
        total_trees *= trees_hit(mountain, element[0], element[1])
    return total_trees
...
print("Trees hit:", trees_hit_multiple_inputs(mountain, inputs))